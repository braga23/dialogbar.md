...
(function ($) {
$('.list_speaker a span').html("Înregistrează-te");
})(jQuery);

(function ($) { 
    $(".btn__more-info").click(function(){
    $(".more__info").slideToggle("slow");
    $(".btn__more-info").css("display", "none");
    $(".three__points").css("display", "none");
    });
})(jQuery);

(function ($) { 
    $(".btn__hide-one").click(function(){
    $(".more__info").slideToggle("slow");
    $(".btn__more-info").css("display", "block");
    $(".three__points").css("display", "inline-block");
    });
})(jQuery);


(function ($) { 
    $(".btn__more-information").click(function(){
    $(".more__info-two").slideToggle("slow");
    $(".btn__more-information").css("display", "none");
    $(".three__points-second").css("display", "none");
    });
})(jQuery);

(function ($) { 
    $(".btn__hide-two").click(function(){
    $(".more__info-two").slideToggle("slow");
    $(".btn__more-information").css("display", "block");
    $(".three__points-second").css("display", "inline-block");
    });
})(jQuery);

(function ($) { 
    $(".btn__aditional-info").click(function(){
    $(".aditional__information").slideToggle("slow");
    $(".btn__aditional-info").css("display", "none");
    });
})(jQuery);

(function ($) { 
    $(".btn__aditional-close").click(function(){
    $(".aditional__information").slideUp("slow");
    $(".btn__aditional-info").css("display", "block");
    });
})(jQuery);

(function ($) {
$('.rpt_foot').removeAttr('target');
})(jQuery);
