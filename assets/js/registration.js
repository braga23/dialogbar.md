...
// (function ($) {
// If( $('#element').is(':visible')){do stuff}
// // $('input[data-original-title="Nume*"]').attr("data-original-title", "Completați Caseta Nume");
// $('.tooltip .tooltip-inner').html("Completați Caseta Nume");
// };
// })(jQuery);

// (function ($) {
// $('#tooltip265379 .tooltip-inner').html("Completați Caseta Email");
// })(jQuery);

// (function ($) {
// $('#tooltip9704689 .tooltip-inner').html("Selectați Cursul");
// })(jQuery);