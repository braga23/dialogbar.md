            ...
            <div class=" menu_pos">
                    ...
                    <div class="logo">
                        <a href="<?php echo esc_url(home_url('/')); ?>" title="<?php bloginfo('name'); ?>">
                            ...
                            <?php } else{  ?> <img src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2016/11/dialog_on_black.svg" style="height:76px;" alt="<?php echo esc_attr(bloginfo('name')); ?>"/><?php /*bloginfo('name');*/ } ?>
                        </a>
                    </div>
                    ...
                    <nav class="menutop navbar navbar-default ">
                            ...
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand logo_image" href="<?php echo esc_url(home_url('/')); ?>" title="<?php bloginfo('name'); ?>">
                                    <?php if( get_theme_mod( 'logo_img', '' ) != '' ) { ?>
                                        <img src="<?php  echo esc_url( get_theme_mod('logo_img', '') ); ?>" alt="<?php echo esc_attr(bloginfo('name')); ?>"/>   
                                    <?php } else{  ?> <img src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2016/11/dialog_on_black.svg" style="height:56px;margin-top:-19px;" alt="<?php echo esc_attr(bloginfo('name')); ?>"/><?php /*bloginfo('name');*/ } ?>
                                </a>
                            </div>
